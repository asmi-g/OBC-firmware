...
#if (defined __linux__ || defined __APPLE__ || defined __CYGWIN__ || defined __QNXNTO__ || 1)
	#include <stdlib.h>
	#include <unistd.h>
	#include <stddef.h>
	#include <pthread.h>
...
#elif (defined __linux__ || defined __APPLE__ || defined __CYGWIN__ || defined __QNXNTO__ || 1)
